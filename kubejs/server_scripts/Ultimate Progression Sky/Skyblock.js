onEvent('recipes', event => {  
    ...
    //Leaves Waterlogged Sieve Drops | output
    const leaves_water_sieve_drops = [
    ...
    for(let drops of leaves_water_sieve_drops){
        sieve("#minecraft:leaves",drops,"string",0.01,null,null,null,null,true)
    }
    ...
    sieve("#forge:sand","byg:ametrine_gems","iron",0.02,"emerald",0.01,null,null,null)
    ...
    //fluid drill lava recipe remove

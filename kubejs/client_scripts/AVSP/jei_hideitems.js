...
//CERTUS QUARTZ
	...
	//Certus quartz ore
	event.hide('appliedenergistics2:certus_quartz_ore')
	//Crushed certus quartz
	event.hide('emendatusenigmatica:certus_quartz_crushed')
//
//CHARGED CERTUS QUARTZ
	//Charged certus quartz crystal
	...
	//Charged certus quartz ore
	event.hide('appliedenergistics2:charged_certus_quartz_ore')
	//Crushed charged certus quartz
	event.hide('emendatusenigmatica:charged_certus_quartz_crushed')
...
//QUARTZ
	//Crushed quartz
	event.hide('emendatusenigmatica:quartz_crushed')
//
//FLUORITE
	//Fluorite crystal
...
//OTHER
	...
	event.hide('emendatusenigmatica:ancient_debris_crushed')
	event.hide('emendatusenigmatica:thallasium_crushed')
	event.hide('emendatusenigmatica:iesnium_crushed')
	event.hide('emendatusenigmatica:regalium_crushed')
	event.hide('emendatusenigmatica:utherium_crushed')
	event.hide('emendatusenigmatica:froststeel_crushed')
	event.hide('emendatusenigmatica:cloggrum_crushed')
	event.hide('emendatusenigmatica:nebu_crushed')

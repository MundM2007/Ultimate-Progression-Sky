...
//Cobalt
<recipetype:create:milling>.addRecipe("create.milling/cobalt_ore", [<item:emendatusenigmatica:cobalt_crushed> * 1], <tag:items:forge:ores/cobalt>);
<recipetype:create:crushing>.addRecipe("create.crushing/cobalt_ore", [<item:emendatusenigmatica:cobalt_crushed> * 1, <item:emendatusenigmatica:cobalt_crushed> * 2 % 30], <tag:items:forge:ores/cobalt>);
